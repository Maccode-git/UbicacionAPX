...
/**
 * Test for transaction UBICT00201COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/UBICT00201COTest.xml" })
public class UBICT00201COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(UBICT00201COTransactionTest.class);
	
	@Autowired
	private UBICT00201COTransaction transaction;
	...
	@Test
	 public void testTransaction() {
		 DataInUbiDTO data = request();
		 this.addParameter("dataInUbiDTO", data);
		 this.transaction.execute();
	 }

	 private DataInUbiDTO request() {
		 DataInUbiDTO request = new DataInUbiDTO();
		 request.setOrigen("BOGOTA");
		 request.setDestino("SOACHA");
		 return request;
	 }
}
